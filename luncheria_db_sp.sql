...
--
-- Host: localhost    Database: luncheria_db
-- ------------------------------------------------------
...
--
-- Current Database: `luncheria_db`
--
DROP DATABASE IF EXISTS `luncheria_db`;


CREATE DATABASE /*!32312 IF NOT EXISTS*/ `luncheria_db` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci */;
...
INSERT INTO `categorias` VALUES (1,'Víveres',NULL),(2,'Alimentos',NULL),(3,'Bebidas',NULL);
...
CREATE TABLE `compras` (
  ...
  `metodo_pago` enum('B','E','P','T','M') COLLATE utf8_spanish_ci NOT NULL,
  `fecha_compra` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `id_cliente` int(11) NOT NULL,
  `id_empleado` int(11) NOT NULL,
  `condicion` enum('CO','CR') COLLATE utf8_spanish_ci DEFAULT 'CO',
  `pagado` enum('0','1') COLLATE utf8_spanish_ci DEFAULT '1',
...
--
-- Table structure for table `compras_contienen_productos`
--
...
INSERT INTO `correos` VALUES (1,'algo@algo.algo'),(2,'augusto_linares22@gmail.com'),(3,'ange.nogales90@gmail.com'),(4,'smestrella2012@gmail.com');
...
INSERT INTO `direcciones` VALUES (1,6050,'Pueblo Nuevo Sur','Avenida Francisco de Miranda','Local','10','',79),(2,6050,'Sector Pueblo Nuevo Sur','Calle 11','Casa','12','',79),(3,6050,'Sector San Francisco de Asís','Calle Cajigal','Casa','89','',79),(4,6050,'Comunidad','Principal','Casa','','Frente A La Plaza Bolivar',79);
...
CREATE TABLE `empleados` (
  ...
  `eliminado` enum('0','1') COLLATE utf8_spanish_ci DEFAULT '0',
  ...
  CONSTRAINT `fk_id_user_emple` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `empleados` VALUES (1,'GERENTE','2012-05-10','2024-09-27 04:03:34',1,'0'),(2,'COCINERO','2024-11-11','2025-01-14 16:39:10',NULL,'0'),(3,'COCINERO','2024-11-15','2025-01-17 01:20:34',NULL,'0');
...
CREATE TABLE `empresas` (
  ...
  `tipo_rif` enum('V','E','P','G','J') COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `empresas` VALUES (1,'V',123456781,'Luncheria El Sazón de La Primera',NULL,NULL,NULL,'2025-01-14 02:47:38');
...
CREATE TABLE `personas` (
  ...
  `tipo_ci` enum('V','E') COLLATE utf8_spanish_ci DEFAULT 'V',
  ...
  `nombre3` varchar(20) COLLATE utf8_spanish_ci DEFAULT NULL,
  `apellido1` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `apellido2` varchar(20) COLLATE utf8_spanish_ci DEFAULT NULL,
  `fecha_nac` date DEFAULT NULL,
  `sexo` enum('M','F') COLLATE utf8_spanish_ci DEFAULT NULL,
  `edo_civil` enum('S','C','D','V') COLLATE utf8_spanish_ci DEFAULT 'S',
  `id_direccion` int(11) DEFAULT NULL,
  `id_telefono` int(11) DEFAULT NULL,
  `id_correo` int(11) DEFAULT NULL,
...
INSERT INTO `personas` VALUES (1,'V',12345678,'Pedro',NULL,NULL,'Pérez',NULL,'1989-01-01','M','S',NULL,NULL,NULL),(2,'V',28456981,'Augusto','José',NULL,'Linares','Rondón','2003-03-19','M','S',2,2,2),(3,'V',25909234,'Angelica','Carolina',NULL,'Nogales','Tiapa','1996-03-28','F','S',3,3,3);
...
INSERT INTO `productos` VALUES (4,'Pastelito De Pollo','Pastelito 20 Cm',NULL,1.40,'2025-01-14 06:24:22','2025-01-15 20:18:09',2,'1'),(5,'Empanada De Pollo','Empanada De 20 Cm','/imagen_678915ac0ac8f.png',1.40,'2025-01-16 14:20:28','2025-01-16 14:21:49',2,'0'),(6,'Empanada De Carne','Empanada De 20 Cm','/imagen_678a50406370d.png',1.50,'2025-01-16 23:48:40','2025-01-17 12:42:40',2,'0');
...
INSERT INTO `proveedores` VALUES (1,'J',452390932,'Jumbo El Tigre',1,1,1,1,'2025-01-14 06:27:06'),(2,'J',30912901,'La Estrella 2012',4,4,4,1,'2025-01-25 07:59:21');
/*!40000 ALTER TABLE `proveedores` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `proveedores_abastecen_suministros`
--
...
CREATE TABLE `proveedores_abastecen_suministros` (
  ...
  `fecha_vencimiento_suministro` date DEFAULT NULL,
  `cantidad` smallint(5) unsigned NOT NULL,
  `condicion_pago` enum('CO','CR') COLLATE utf8_spanish_ci DEFAULT 'CO',
  ...
  CONSTRAINT `fk_provee_a_sumi` FOREIGN KEY (`id_suministro`) REFERENCES `suministros` (`id_suministro`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
-- Dumping data for table `proveedores_abastecen_suministros`
--

LOCK TABLES `proveedores_abastecen_suministros` WRITE;
/*!40000 ALTER TABLE `proveedores_abastecen_suministros` DISABLE KEYS */;
INSERT INTO `proveedores_abastecen_suministros` VALUES (3,1,3,'2025-01-20','2025-01-20','2025-12-04',10,'CO',35.00,1700.00),(4,1,4,'2025-01-20','2025-01-20','2025-12-01',5,'CO',16.50,890.23),(5,1,5,'2025-01-20','2025-01-20','2026-12-09',36,'CO',23.40,1359.90),(6,2,6,'2025-01-20','2025-01-20','2026-05-09',6,'CO',15.50,860.43),(7,1,1,'2025-01-20','2025-01-20','2025-11-09',10,'CO',12.00,649.05);
/*!40000 ALTER TABLE `proveedores_abastecen_suministros` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `suministros` VALUES (1,20252301671993,'Harina de Trigo Pampa','Suministro','/imagen_67924d2a6951d.png','2025-01-23 14:07:50',1),(2,20252301716083,'Mayonesa Mavesa 500 Gr','Suministro','/imagen_679260d184d98.png','2025-01-23 15:31:32',1),(3,20252301506378,'Aceite Vatel 1 Litro','Suministro','/imagen_6792658a2c80a.jpg','2025-01-23 15:51:38',1),(4,2025230160583,'Harina Pan 1 Kg','Suministro','/imagen_6792731bcf05c.png','2025-01-23 16:49:48',1),(5,20252501192904,'Malta Retornable','Malta De Botella Retornable Maltin Polar','/imagen_679486a6a78c4.jpg','2025-01-25 06:37:27',3),(6,2025250170504,'Malta Litro Y Medio','Suministro','/imagen_679499d400430.png','2025-01-25 07:59:21',3);
...
INSERT INTO `tasas_cambio` VALUES (1,'Banco Central de Venezuela (BCV)',55.00,'2025-01-17 01:14:39');
...
INSERT INTO `telefonos` VALUES (1,'M',0414,1234567),(2,'M',0414,1234567),(3,'M',0412,9090987),(4,'M',0412,1290912);
...
CREATE TABLE `usuarios` (
  ...
  `avatar` varchar(70) COLLATE utf8_spanish_ci DEFAULT NULL,
...
INSERT INTO `usuarios` VALUES (1,'admin','$2y$10$DwpvwARM3mET65jbM1BO/OqPqNmL1/9ET4zb07dribFdjuzvG8.vG',NULL,1,'2025-01-14 02:47:34');
