...
<body>
	...
	<main>
        <section class="login">
            <form action="" method= "POST" class="form" id="frmChangePass">
                ...
                <div class="form__input">
                    <input type="password" name="password" id="password-0" class="form__input-input" placeholder="Ingrese la contraseña">
                    <label for="password" class="form__input-label">Contraseña Actual</label>

                    <button type="button" class="form__input__eye" id="show-pass-btn-0">
                        <img src="<?= RUTAIMG ?>eye.svg" alt="Ver contraseña" class="form__input__eye-img-0">
                    </button>
                </div>
                ...
                <div class="form__input">
                    <input type="password" name="password" id="password-2" class="form__input-input" placeholder="Ingrese la contraseña">
                    <label for="password" class="form__input-label">Repita la contraseña</label>
